...
def evaluate(dim, rec, dec, test_loader, args, num_sample=10, device="cuda"):
    ...
    with torch.no_grad():
        for test_batch in test_loader:
            subsampled_tp, subsampled_data, subsampled_mask, observed_tp, observed_data, observed_mask = (tensor.to(device) for tensor in test_batch)
            ...
            mse += mean_squared_error(observed_data, pred_x, observed_mask) * observed_mask.sum()
